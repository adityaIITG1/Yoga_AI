    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 w-72"
            >
                {/* Main Panel */}
                <div className={`
                ...
                `}>
                    ...
                    {(heartRate || energyLevel !== undefined) && (
                        <div className="relative px-6 py-3 border-b border-white/10 bg-black/20">
                    ...
                    {guidanceHistory.length > 1 && (
                        <div className="relative px-6 py-4 border-t border-white/10 bg-black/20">
                            <p className="text-white/40 text-xs uppercase tracking-wider mb-3">Recent Guidance</p>
                            <div className="space-y-2">
                                {guidanceHistory.slice(1).map((msg, idx) => (
                                    <motion.div
                                        ...
                                        className="text-white/50 text-xs leading-relaxed pl-3 border-l-2 border-white/20"
                                    >
                                        {msg}
                                    </motion.div>
                                ))}
